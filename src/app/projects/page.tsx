...
export default function ProjectsPage() {
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="max-w-full mx-auto px-[2rem] md:px-[96px]">
        <FilterSection
        ...
        {filteredProjects.length > INITIAL_VISIBLE_COUNT && (
          <div className="flex justify-center mt-16">
            <button
              ...
              className="group flex items-center cursor-pointer gap-2 px-8 py-3 rounded-full bg-[#F1F5F9] text-[#64748B] font-semibold hover:bg-[#67B5DC] hover:text-white transition-all duration-300"
            >
